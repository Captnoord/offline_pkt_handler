...
/* Current Macho message types names
	MACHONETMSG_TYPE_AUTHENTICATION_REQ
	MACHONETMSG_TYPE_SESSIONCHANGENOTIFICATION
	MACHONETMSG_TYPE_SESSIONINITIALSTATENOTIFICATION
	MACHONETMSG_TYPE_PING_REQ
	MACHONETMSG_TYPE_PING_RSPR
	MACHONETMSG_TYPE_ERRORRESPONSE
	MACHONETMSG_TYPE_IDENTIFICATION_RSP
	MACHONETMSG_TYPE_IDENTIFICATION_REQ
	MACHONETMSG_TYPE_CALL_RSP
	MACHONETMSG_TYPE_CALL_REQ
	MACHONETMSG_TYPE_TRANSPORTCLOSED
	MACHONETMSG_TYPE_RESOLVE_RSP
	MACHONETMSG_TYPE_RESOLVE_REQ
	MACHONETMSG_TYPE_NOTIFICATION
	MACHONETMSG_TYPE_AUTHENTICATION_RSP
*/
...
//see PyPacket.cpp
extern const char *MACHONETMSG_TYPE_str[MACHONETMSG_TYPE_MAX];
